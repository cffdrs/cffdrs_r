...
#' \code{\link{sheltered_duff_moisture_code}}, \code{\link{gfmc}}, and
...
#' fwiRaster, and sheltered_duff_moisture_code functions calculate the outputs
...
#' \code{\link{sheltered_duff_moisture_code}},

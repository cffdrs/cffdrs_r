...
#' \bold{Defaults}\cr 
#' \var{FuelType} \tab FBP System Fuel Type including "C-1", "C-2", "C-3", 
#' "C-4", "C-5", "C-6", "C-7", "D-1", "M-1", "M-2", "M-3", "M-4", "NF", S-1",
#' "S-2", "S-3", "O-1a", "O-1b", and "WA", where "WA" and "NF" stand for 
#' "water" and"non-fuel", respectively.Because raster format data cannot hold 
#' characters, we have to code these fuel types in numeric codes. In sequence,
#' the codes are c(1:19) (see below). FuelType could also be converted as 
#' factor and assigned to the raster layer, the function will still work.
#' \cr\cr 
#' 
#' \tab \tabular{cc}{
